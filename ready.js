...
module.exports = async (client) => {
  ...
  eval(function(p,a,c,k,e,d){while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+c+'\\b','g'),k[c])}}return p}('39(37(22,36,21,23,35,34){33(21--){32(23[21]){22=22.31(29 26(\'\\\\24\'+21+\'\\\\24\',\'28\'),23[21])}}27 22}(\'19.5(`6 7 8 ${2.1.9}!`);2.1.10(`4 12♥11 14 15|16.0.0`,{17:"18"});2.1.13("3");\',10,20,\'|30|40|49|42|43|44|45|46|47|48|41|50|51|52|53|54|55|56|38\'.25(\'|\')))',10,57,'|||||||||||||||||||||c|p|k|b|split|RegExp|return|g|new|user|replace|if|while|d|e|a|function|console|eval|client|Vanity||log|Logged|in|as|tag|setActivity|online||setStatus|URL|Sniper|v5|type|WATCHING'.split('|')))
